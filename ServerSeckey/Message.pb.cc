...
void RequestMsg::SerializeWithCachedSizes(
  ...
  // int64 cmdType = 1;
  if (this->cmdtype() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64(1, this->cmdtype(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* RequestMsg::InternalSerializeWithCachedSizesToArray(
  ...
  // int64 cmdType = 1;
  if (this->cmdtype() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(1, this->cmdtype(), target);
  }
...
void RespondMsg::SerializeWithCachedSizes(
  ...
  // int64 seckeyID = 2;
  if (this->seckeyid() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64(2, this->seckeyid(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* RespondMsg::InternalSerializeWithCachedSizesToArray(
  ...
  // int64 seckeyID = 2;
  if (this->seckeyid() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(2, this->seckeyid(), target);
  }
