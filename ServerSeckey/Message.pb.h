...
class RequestMsg :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 cmdtype() const;
  void set_cmdtype(::PROTOBUF_NAMESPACE_ID::int64 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 cmdtype_;
...
class RespondMsg :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 seckeyid() const;
  void set_seckeyid(::PROTOBUF_NAMESPACE_ID::int64 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr serverid_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr data_;
  ::PROTOBUF_NAMESPACE_ID::int64 seckeyid_;
  bool status_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_Message_2eproto;
};
...
inline ::PROTOBUF_NAMESPACE_ID::int64 RequestMsg::cmdtype() const {
  // @@protoc_insertion_point(field_get:RequestMsg.cmdType)
  return cmdtype_;
}
inline void RequestMsg::set_cmdtype(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void RespondMsg::clear_seckeyid() {
  seckeyid_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 RespondMsg::seckeyid() const {
  // @@protoc_insertion_point(field_get:RespondMsg.seckeyID)
  return seckeyid_;
}
inline void RespondMsg::set_seckeyid(::PROTOBUF_NAMESPACE_ID::int64 value) {
